...
import Reviewtbl from './Reviewtbl2';
...
class Review extends Component {
    constructor() {
        super();
        var apiBaseUrl = "http://localhost:8080/getClientEmpList";
        ...
        var self = this;
        axios.post(apiBaseUrl, {emp_id: sessionStorage.getItem('User')})                             // Populating the employee Dropdown using api
