...
class TokenCache {
    ...
    private $username = 'abcTech@gmail.com';
    private $password = 'test1234';
    private $client_id = '1';
    private $client_secret = 'g260uxoQJTSgPP68wVKIdzAdGqT0UUOk1iS6y5Qw';
    ...
    public function retrieveToken(){
        ...
        $response = $client->post('http://apigateway.dev/oauth/token', [ 'form_params' => $requestParams ]);
    ...
    public function revokeTokens() {
        ...
        $client = new GuzzleHttp\Client();
        $client->post('http://apigateway.dev/oauth/token', [ 'form_params' => $requestParams ]);
